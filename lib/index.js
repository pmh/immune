...
exports.OneOf = OneOf;
exports.zip = exports.kvp = exports.vals = exports.evolve = exports.mapError = exports.dissocIn = exports.assocIn = exports.getIn = exports.into = exports.take = exports.remove = exports.removeKV = exports.filter = exports.every = exports.any = exports.sliceFrom = exports.slice = exports.join = exports.flatMap = exports.foldrKV = exports.foldlKV = exports.getInOrElse = exports.getOrElse = exports.liftA6 = exports.liftA5 = exports.liftA4 = exports.liftA3 = exports.liftA2 = exports.pipe = exports.memoize = exports.fork = exports.Task = exports.result = exports.Result = exports.maybe = exports.Maybe = exports.Product = exports.Sum = exports.flatten = exports.of = exports.IMonadic = exports.ap = exports.IApply = exports.IFlatMapError = exports.bimap = exports.IBifunctor = exports.cata = exports.ICata = exports.map = exports.IFunctor = exports.foldr = exports.foldl = exports.IFold = exports.append = exports.empty = exports.IMonoid = exports.get = exports.ILookup = exports.disj = exports.ISet = exports.dissoc = exports.assoc = exports.IAssociative = exports.keys = exports.IKeyed = exports.iterator = exports.IIterator = exports.filterKV = exports.conj = exports.ICollection = exports.rest = exports.first = exports.ISeq = exports.hash = exports.IHash = exports.count = exports.ICount = exports.shallowClone = exports.clone = exports.IClone = exports.show = exports.IShow = exports.caseOf = exports.Union = exports.Type = exports.defmethod = exports.defmulti = exports.implementsProtocol = exports.extendType = exports.extendProtocol = exports.Protocol = exports.comp = exports.is = exports.assert = exports.curry = exports.withMeta = exports.__ = exports.identity = exports.id = exports.showType = void 0;
exports.uppercase = exports.lowercase = exports.replace = exports.split = exports.deepEqual = exports.shallowEqual = exports.equal = exports.intersperse = void 0;
...
var is = curry(function (type, obj) {
  ...
  if (obj[KindKey] === UnionType && (!type[UnionCase] || type[UnionCase] === obj[UnionCase]) && (obj[TypeKey] === type[TypeKey] || type[TypeKey] === undefined)) if (type._tag === "TypedUnion") {
    return obj[UnionValues].every(function (t, i) {
...
exports.bimap = bimap;
var IFlatMapError = Protocol("IFlatMapError", {
  flatMapError: ["f", "m"]
});
exports.IFlatMapError = IFlatMapError;
...
var fork = curry(function (fail, succeed, task) {
  return task.fork(function (err) {
    ...
    if (is(Array, succeed)) {
      var _succeed = _toArray(succeed),
          f = _succeed[0],
          args = _succeed.slice(1);
...
extendType(Array, IShow, {
  ...
  filterKV: function filterKV(f, xs) {
    return xs.filter(function (v, k) {
      return f(k, v);
    });
  }
}, IIterator, {
...
extendType(String, IShow, {
  ...
  filterKV: function filterKV(f, xs) {
    return xs.split("").filter(function (v, k) {
      return f(k, v);
    }).join("");
  }
}, IIterator, {
...
extendType(Object, IShow, {
  ...
  filterKV: function filterKV(f, obj) {
    return _foldl(function (k, acc) {
      return f(k, obj[k]) ? _assoc(k, obj[k], acc) : acc;
    }, {}, Object.keys(obj));
  }
}, ILookup, {
...
extendType(Result, IClone, {
  ...
  flatMapError: function flatMapError(f, fa) {
    return caseOf({
      Ok: Result.Ok,
      Err: f
    }, fa);
...
extendType(Task, IShow, {
  ...
  flatMapError: function flatMapError(f, fa) {
    return Task(function (fail, succeed) {
      fa.fork(function (err) {
        return f(err).fork(fail, succeed);
      }, succeed);
    });
  }
}, IMonadic, {
  ...
  flatten: function flatten(t) {
    return Task(function (fail, succeed) {
      return fork(fail, fork(fail, succeed), t);
    });
  }
}, IApply, {
  ap: function ap(tb, ta) {
    return flatMap(_map(__, tb), ta);
  }
}); // -- Function Utils
...
var flatMap = curry(function (fn, m) {
...
var intersperse = function intersperse(xs, sep) {
  return _foldl(function (item, acc) {
    return count(acc) === count(xs) - 1 ? conj(item, acc) : count(acc) === 0 ? conj(item, acc) : conj(item, conj(sep, acc));
  }, _empty(xs), xs);
};
/*
